    ...
    <div className="fixed inset-0 flex bg-white overflow-hidden">
      ...
      <div className="relative w-[46%] min-w-[400px] overflow-hidden bg-[#0c2436] hidden md:block">
        ...
        <img
          ...
          style={{ filter: 'saturate(1.05) contrast(1.03)', transform: 'scale(1.02)' }}
          crossOrigin="anonymous"
          onError={(e) => { (e.target as HTMLImageElement).style.display = 'none' }}
        />
        {/* Gradient overlay */}
        <div className="absolute inset-0" style={{
          background: 'linear-gradient(195deg, rgba(6,16,28,0.30) 0%, rgba(6,16,28,0.40) 45%, rgba(4,10,20,0.86) 100%)',
        }} />
        {/* Aurora effect */}
